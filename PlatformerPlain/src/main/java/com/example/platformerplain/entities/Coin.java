...
//    };
//
//    public Coin(int x, int y, int w, int h) { //todo: remove useless parameters
//        Rectangle hitBox = new Rectangle(w, h, Color.GOLD);
...
//        Image sprite = CutSpriteSheet.getSprite(EntityType.COIN, (int) (Math.random() * 5), (int) (Math.random() * 7));
